...
pipelineConfigRepo = "https://github.com/MDASII-BAH/Challenge2FrontEnd.git"
...
multibranchPipelineJob('frontend') {
  // branchSources {
  //   git {
  //     remote('https://github.com/MDASII-BAH/Challenge2FrontEnd.git')
